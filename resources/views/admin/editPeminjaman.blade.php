                    ...
                    <div class="card-body">
                        ...
                        <form action="/postEditPeminjaman/{{ $data->id }}" method="POST">
                            ...
                            <div class="form-group mt-1">
                                ...
                                <input type="date" class="form-control border border-secondary form-control" name="tanggalPeminjaman" required value="{{ $data->tanggal_pinjam }}">
                                <span class="text-danger">
                            ...
                            <div class="form-group mt-1">
                                ...
                                <input type="date" class="form-control border border-secondary form-control" name="tanggalPengembalian" required value="{{ $data->tanggal_kembali }}">
                                <span class="text-danger">
